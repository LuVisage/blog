  ...
  return (
    <header className="sticky top-3 z-50 w-full px-4">
      <div className="max-w-5xl xl:max-w-6xl mx-auto">
        <div className="flex items-center justify-between h-14 px-4 sm:px-6 rounded-2xl glass">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="md:hidden w-11 h-11 rounded-xl glass flex items-center justify-center cursor-pointer"
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden relative z-50 mt-2 rounded-2xl glass overflow-hidden" role="navigation" aria-label="移动端导航">
              ...
              {NAV_LINKS.map((link) => {
                ...
                return (
                  <Link
                    ...
                    href={link.href}
                    onClick={() => setMobileMenuOpen(false)}
                    className="block px-3 py-3 rounded-xl text-base font-medium transition-colors cursor-pointer"
                    style={{
                      color: isActive ? 'var(--color-ink)' : 'var(--color-muted)',
                      backgroundColor: isActive ? 'rgba(255,255,255,0.5)' : 'transparent',
                    }}
