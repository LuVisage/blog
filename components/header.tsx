  ...
  return (
    <header className="sticky top-3 z-50 w-full px-4">
      <div className="max-w-5xl xl:max-w-6xl mx-auto">
        <div className="flex items-center justify-between h-16 px-4 sm:px-6 rounded-2xl backdrop-blur-xl bg-white/50 dark:bg-black/40 border border-white/20 dark:border-white/10 shadow-lg shadow-black/5 dark:shadow-black/25">
          {/* Logo */}
          <Link
            href="/"
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <a
              ...
              className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-medium bg-white/50 dark:bg-white/10 border border-white/20 dark:border-white/10 text-gray-800 dark:text-gray-300 hover:border-gray-400 dark:hover:border-white/20 hover:shadow-sm transition-all"
            ...
            <button
              ...
              className="md:hidden w-9 h-9 rounded-xl border border-white/20 dark:border-white/10 flex items-center justify-center hover:bg-white/50 dark:hover:bg-white/5 transition-colors"
              aria-label="菜单"
            >
        ...
        {/* Mobile menu */}
        {mobileMenuOpen && (
          <nav className="md:hidden mt-2 rounded-2xl backdrop-blur-xl bg-white/60 dark:bg-black/50 border border-white/20 dark:border-white/10 shadow-lg overflow-hidden">
