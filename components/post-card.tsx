...
export function PostCard({ post, index = 0 }: { post: PostMeta; index?: number }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Card */}
        <div className="relative h-full rounded-2xl glass-card p-5 sm:p-6 flex flex-col overflow-hidden transition-all duration-500 group-hover:-translate-y-1 group-hover:shadow-xl group-hover:shadow-black/10 dark:group-hover:shadow-black/30">
          {/* Glare overlay — Uiverse.io / Aceternity inspired */}
          <div
          ...
          <div
            ...
            style={{
              ...
              background: 'linear-gradient(135deg, rgba(180,180,200,0.2), rgba(140,140,160,0.1), rgba(200,200,220,0.15))',
            }}
          />
