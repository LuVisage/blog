    ...
    <>
              ...
              <li key={id}>
                <a
                  ...
                  className={`block text-sm py-1.5 transition-all duration-200 border-l-2 line-clamp-1 ${
                    activeId === id
                      ? 'border-pink-500 text-pink-600 dark:text-pink-400 font-medium pl-3'
                      : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-pink-500 dark:hover:text-pink-400 hover:border-pink-200 dark:hover:border-pink-800 pl-3'
      ...
      <div className="xl:hidden mb-6">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-2xl glass-card text-sm text-gray-600 dark:text-gray-400 hover:text-pink-500 dark:hover:text-pink-400 transition-colors"
        >
