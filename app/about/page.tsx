            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {SOCIAL_LINKS.github && (
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 dark:bg-white/5 border border-white/10 dark:border-white/10 text-sm text-gray-800 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-200 transition-all"
                >
      ...
      <div className="rounded-3xl glass-card p-6 sm:p-10 lg:p-12 mb-8">
        ...
        <div className="flex flex-wrap gap-2">
          {ABOUT.skills.map((skill) => (
            <span
              key={skill}
              className="px-3 py-1.5 rounded-full text-sm font-medium bg-white/10 dark:bg-white/5 text-gray-800 dark:text-gray-300 border border-white/10 dark:border-white/10"
            >
              {skill}
            </span>
          ))}
