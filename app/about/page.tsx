              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {SOCIAL_LINKS.github && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/50 dark:bg-white/10 border border-white/10 dark:border-white/10 text-sm text-gray-800 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-200 transition-all"
                  >
        ...
        <div className="rounded-3xl glass-card p-6 sm:p-10 lg:p-12 mb-8">
          ...
          <div className="flex flex-wrap gap-2">
            {ABOUT.skills.map((skill) => (
              <span
                key={skill}
                className="px-3 py-1.5 rounded-full text-sm font-medium bg-white/50 dark:bg-white/10 text-gray-800 dark:text-gray-300 border border-white/10 dark:border-white/10"
              >
                {skill}
              </span>
            ))}
            ...
            {ABOUT.timeline.map((item, i) => (
              <div key={i} className="flex gap-4">
                <div className="flex-shrink-0 w-16 text-right">
                  <span className="text-sm font-bold text-gray-700 dark:text-gray-300">{item.year}</span>
                </div>
