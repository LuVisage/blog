              ...
              >
                ...
                <div className="absolute inset-0 rounded-full flex items-center justify-center bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                  <span className="text-white text-[10px] sm:text-xs px-2 text-center leading-tight">
                    📷 将照片保存为<br /><code className="text-gray-300">public/avatar.jpg</code>
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3">
                {SOCIAL_LINKS.github && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-white/10 dark:bg-white/5 border border-white/10 dark:border-white/10 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-white/30 dark:hover:border-white/10 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5"
                  >
      ...
      <section className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        <div className="flex items-center justify-between mb-6 lg:mb-8">
          ...
          {posts.length > 0 && (
            <Link
              href="/posts"
              className="text-sm lg:text-base text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors flex items-center gap-1 font-medium"
            >
              查看全部
